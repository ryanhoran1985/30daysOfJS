 // Get your shorts on - this is an array workout!
    ...
    //     soloYears = inventors[i].passed - inventors[i].year
    //     totalYears += soloYears
    //   }

      const totalYears = inventors.reduce((total, perInventor) => {
        return total + (perInventor.passed - perInventor.year)
      }, 0)
